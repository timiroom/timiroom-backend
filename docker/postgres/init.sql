...
-- RAG 문서 청크 저장 테이블 (1024차원)
-- Note: pgvector ivfflat/hnsw index max 2000-dim → 1024-dim은 IVF_FLAT 인덱스 가능
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_chunks_content_hash ON document_chunks (content_hash) WHERE content_hash IS NOT NULL;
